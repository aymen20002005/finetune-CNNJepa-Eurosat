...
class LightlyModel(pl.LightningModule):
    ...
    def setup(self, stage: str) -> None:
        dataset_classes = {
            ...
            "imagenet-100-folder": torchvision.datasets.ImageFolder,
        ...
        train_dataset_kwargs = {
            ...
            "imagenet-100-folder": dict(root=self.cfg.data.get('train_root', '/data/imagenet100/train')),
            "eurosat": dict(root=self.cfg.data.get('root', 'EuroSAT'), split='train'),
        }
        val_dataset_kwargs = {
            ...
            "imagenet-100-folder": dict(root=self.cfg.data.get('val_root', '/data/imagenet100/val')),
            "eurosat": dict(root=self.cfg.data.get('root', 'EuroSAT'), split='validation'),
        }
        input_sizes = {
            "cifar10": 32,
            "stl10":  96,
